...
(function (root, factory) {
  ...
  const EVENT_TYPE_LABELS = {
    ...
    membership_gift:         { label: '贈送會籍(購買方)', category: 'donation', platform: 'youtube' },
    membership_gift_received: { label: '贈送會籍(領取方)', category: 'donation', platform: 'youtube' },
  ...
  const PLATFORM_DONATION_NOTES = [
    ...
    },
    {
      ...
      note: 'Super Chat / Super Sticker 依實際付款金額分色階(金額越高,訊息在聊天室置頂時間越久、顏色越顯眼);'
          ...
          + '只有份數,沒有金額(YouTube 原始封包本身沒有揭露單價,2026-08-15 用真實封包驗證過)。',
    },
    {
      platform: 'soop',
      title: 'SOOP',
